...
const LeftAsideHome = () => {
  return (
    <>
      ...
      <Button className="text-primary bg-light rounded-pill ms-3 mt-2 px-4 py-3 ">
        <div className="fw-semibold d-flex justify-content-center align-items-center">
          <PencilSquare className="fs-4 me-1" />
          <span className="ms-2">Pubblica offerta gratuita</span>
        </div>
      </Button>
    </>
  );
