    ...
    <Navbar className="bg-body-white border-bottom p-0 bg-white sticky-top">
      <Container className="justify-content-start">
        ...
        <div className=" text-secondary px-4 border-end">
          <img src={me?.image || "https://cdn-icons-png.flaticon.com/512/6596/6596121.png"} alt="" width={32} height={32} className="rounded-circle" />
          <NavDropdown title="Tu" id="profile-nav-dropdown" align="end" className="fs-7 text-center">
            <div className="d-flex align-items-center">
              <img
                src={me?.image || "https://cdn-icons-png.flaticon.com/512/6596/6596121.png"}
        ...
        <div className="text-center text-secondary ms-2">
          ...
          <NavDropdown title="Per le aziende" id="second-nav-dropdown" align="end" className="fs-7 text-center mt-1 mx-2">
            <Container className="d-flex p-4 pb-5">
              ...
              <div className="ps-3 pe-5 border-end">
                ...
                <div className="d-flex align-items-center mb-2 ps-3">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" data-supported-dps="40x40" width="50" height="50" focusable="false">
                    <defs>
