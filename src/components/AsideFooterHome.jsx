    ...
    <Container style={{ position: "sticky", top: "85px" }}>
      <Row md={2} className="sticky-top mt-4">
        <Col md={12} className="d-flex flex-wrap justify-content-around">
          ...
          <Dropdown>
            <Dropdown.Toggle drop="up" className="bg-transparent p-0 text-secondary border-0" id="dropdown-basic">
              Privacy & condizioni
            </Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Item href="#/action-1">Informative sulla privacy</Dropdown.Item>
              <Dropdown.Item href="#/action-2">Contrtto di licenza</Dropdown.Item>
          ...
          <Dropdown>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item href="#/action-1" className="d-flex flex-column border-top pt-3">
                <h6>
      ...
      <div className="d-flex justify-content-center align-items-center">
        <img src="https://cdn-icons-png.flaticon.com/128/16183/16183618.png" height={60} width={60} alt="" />
        <p className="mt-3 ms-1">LinkedIn Corporation ©️ 2024</p>
      </div>
    </Container>
  );
};
